...
public class MainActivity extends AppCompatActivity {
    ...
    public void obutson(View view){
        if(gosSayi.get(gosSayi.size()-1).equals("+") || gosSayi.get(gosSayi.size()-1).equals("-") || gosSayi.get(gosSayi.size()-1).equals("/") || gosSayi.get(gosSayi.size()-1).equals("X") || gosSayi.get(gosSayi.size()-1).equals(".")){
            Toast.makeText(getApplicationContext(),"Hatalı İşlem",Toast.LENGTH_LONG).show();
        }
        else if(gosSayi.get(0).equals("/") || gosSayi.get(0).equals("X") || gosSayi.get(gosSayi.size()-1).equals(".")){
            Toast.makeText(getApplicationContext(),"Hatalı İşlem",Toast.LENGTH_LONG).show();
        }
        else{
